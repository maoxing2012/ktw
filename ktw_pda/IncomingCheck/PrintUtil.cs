...
namespace IncomingCheck
{
    class PrintUtil
    {
        ...
        internal static void PrintBill(SkuLabel label, string times)
        {
            int retOpen = 0;
            ...
            try
            {
                ...
                if (retOpen == Def.PT_OK)
                {
                    ...
                    for (int i = 0; i < 1; i++)
                    {
                        ...
                        strPrint.Append("H0046V00170P02K8H");
                        strPrint.Append(GetHexValue("BL入数"));
                        ...
                        strPrint.Append("H0053V00293L0102P01XM");
