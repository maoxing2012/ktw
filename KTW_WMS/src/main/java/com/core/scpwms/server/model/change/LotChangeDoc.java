...
public class LotChangeDoc extends OrderTrackingEntityWithStatus implements
		AllocateDoc {
	...
	/** 明细 */
	private Set<LotChangeDocDetail> details;
	...
	public Set<LotChangeDocDetail> getDetails() {
		return this.details;
	}

	public void setDetails(Set<LotChangeDocDetail> details) {
	...
	public String getStatusEnum() {
		return EnuLotChangeDocStatus.class.getSimpleName();
	}
